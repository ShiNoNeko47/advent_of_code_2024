    ...
    println!(
        ...
        input.iter().fold(0, |acc, area| {
            ...
            area.iter().for_each(|node| {
                ...
                .for_each(|dir| {
                    if (!area.contains(&(
                        (node.0 as isize + dir.0 .0) as usize,
                        (node.1 as isize + dir.0 .1) as usize,
                    )) && !area.contains(&(
                        (node.0 as isize + dir.1 .0) as usize,
                        (node.1 as isize + dir.1 .1) as usize,
                    ))) || (area.contains(&(
                        (node.0 as isize + dir.0 .0) as usize,
                        (node.1 as isize + dir.0 .1) as usize,
                    )) && area.contains(&(
                        ...
                        (node.0 as isize + dir.2 .0) as usize,
                        (node.1 as isize + dir.2 .1) as usize,
                    ))) {
                        perimeter += 1;
                    }
                })
